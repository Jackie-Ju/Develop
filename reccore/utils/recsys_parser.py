...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default="ease", help="the method used to select coreset")
...
args = parse_args()
global_path = 'reccore/config/recsys_global_config.py'
config_file = f'reccore/config/models/{args.model.strip()}_config.py'
